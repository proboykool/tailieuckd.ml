...
if(isset($_POST['link'])){
	...
	$dongy = 'xulyphanmem.php?name='.$ten.'&link='.$link.'&tl='.$theloai.'&mod='.$mode.'&hangxe='.$hangxe;
	$kodongy = 'uploadphanmem.php?name='.$ten.'&link='.$link.'&tl='.$theloai.'&mod='.$mode.'&hangxe='.$hangxe.'&m=1';
}
?>
<!DOCTYPE html>
<html>
